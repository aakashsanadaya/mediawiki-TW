...
openssl rand -base64 6 > /tmp/pswrd
...
ansible-vault encrypt --vault-password-file /tmp/pswrd ansible/hosts
...
ansible-playbook -i ./ansible/hosts ansible/apache.yml --vault-password-file=/tmp/pswrd

ansible-playbook -i ansible/hosts ansible/mysql.yml --vault-password-file=/tmp/pswrd
